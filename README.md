# Hi, I'm Akshay | Data Analyst & Risk Analytics Specialist 👋

Dynamic and business-oriented Data Analyst based in Mumbai, specializing in financial services, portfolio analytics, and credit risk management. I bridge the gap between raw database schemas and executive decision-making.
...
### 📊 [1. Wealth Management Client Churn Analytics](https://github.com/Akshaymest/wealth-management-client-churn-analytics)
* **Objective:** Mitigate portfolio asset leakage by identifying high-risk client account degradation.
* **Tech Stack:** T-SQL, Power BI Desktop, DAX
* **Core Impact:** Implemented a `LAG()` window function layer to isolate clients experiencing 50% or worse month-on-month transaction drops, mapping a 100% churn correlation to a single relationship advisor for corporate intervention.

### 🐍 [2. Credit Risk Underwriting & Loan Default Model](https://github.com/Akshaymest/credit-risk-classification-model)
* **Objective:** Automate retail banking credit gates to minimize non-performing asset (NPA) exposure.
